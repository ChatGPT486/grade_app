...
class ExcelService {
  static const _headerStyle = true;
  ...
  static Future<String> exportByCourse(List<StudentRecord> students) async {
    ...
    for (final entry in grouped.entries) {
      ...
      final courseStudents = entry.value
        ..sort((a, b) => b.totalMark.compareTo(a.totalMark)); // rank by mark
      ...
      summaryCell.value = TextCellValue(
          ...
          'Class Average: ${avgTotal.toStringAsFixed(2)}/100   |   Formula: CA1(/30) + CA2(/30) + Exam(/70) = Total(/100)');
    ...
    final filePath = '${dir.path}/ICT_Grades_$timestamp.xlsx';
